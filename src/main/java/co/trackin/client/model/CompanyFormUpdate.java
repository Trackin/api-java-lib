...
public class CompanyFormUpdate {
    ...
    public CompanyFormUpdate(Company company) {
        ...
        this.customEmailField1 = company.getCustomEmailField1();
        this.customEmailField2 = company.getCustomEmailField2();
        this.customEmailField3 = company.getCustomEmailField3();
        this.customEmailField4 = company.getCustomEmailField4();
        this.customEmailTitle1 = company.getCustomEmailTitle1();
        this.customEmailTitle2 = company.getCustomEmailTitle2();
        this.customEmailTitle3 = company.getCustomEmailTitle3();
        this.customEmailTitle4 = company.getCustomEmailTitle4();
        this.customFtFollowText = company.getCustomFtFollowText();
        this.directionsAvoidHighways = company.getDirectionsAvoidHighways();
        this.directionsAvoidTolls = company.getDirectionsAvoidTolls();
        this.directionsMode = company.getDirectionsMode();
        this.enableGeolocationWarning = company.getEnableGeolocationWarning();
        this.facebook = company.getFacebook();
        this.google = company.getGoogle();
        this.image = company.getImage();
        this.languageCode = company.getLanguageCode();
        this.name = company.getName();
        this.notifyByEmail = company.getNotifyByEmail();
        this.notifyBySms = company.getNotifyBySms();
        this.sendApologyEmail = company.getSendApologyEmail();
        this.sendThankYouEmail = company.getSendThankYouEmail();
        this.skipLoadBalancing = company.getSkipLoadBalancing();
    ...
    public String toString() {
        ...
        sb.append("class CompanyFormUpdateVM {\n");
