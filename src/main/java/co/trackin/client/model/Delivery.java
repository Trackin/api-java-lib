...
public class Delivery {
     ...
     */
    @ApiModelProperty(required = false, value = "Time the delivery began (read-only)")
    @JsonProperty("begin")
     ...
     */
    @ApiModelProperty(required = false, value = "This is the transport distance computed by google directions in meters")
     ...
     */
    @ApiModelProperty(required = false, value = "Time the delivery ended (read-only)")
    @JsonProperty("end")
    public Date getEnd() {
        return end;
    }
     ...
     */
    @ApiModelProperty(required = false, value = "Customer rating /5. (read-only)")
    @JsonProperty("rating")
     ...
     */
    @ApiModelProperty(required = false, value = "This is transport duration computed by google directions in seconds")
    @JsonProperty("time")
    public Long getTime() {
        return time;
    }
     ...
     */
    @ApiModelProperty(required = false, value = "Read-Only, this is the review a user left you after the delivery was made")
